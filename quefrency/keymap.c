...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( /* Base */
    ...
    MO(1),    KC_LGUI,  KC_LALT,         KC_SPC,      MO(2),       KC_SPC, KC_NO,          KC_RALT,  KC_RGUI, KC_NO,  MO(3),   KC_RCTL
  ),
  [1] = LAYOUT( /* FN */
  ...
  [2] = LAYOUT( /* MOUSE MODE */
    ...
    KC_BTN2,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,                    KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, \
  ...
  [3] = LAYOUT(  // RGB
    KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,           KC_NO,  KC_NO,  KC_NO,  KC_NO,  RGB_VAD,  RGB_VAI, KC_NO,  KC_NO, \
    KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,                     KC_NO, KC_NO,  KC_NO,  KC_NO,  KC_NO,  RGB_SPD,  RGB_SPI, KC_NO, \
    KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,                       KC_NO, KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, \
    KC_NO,  RGB_RMOD, RGB_MOD,  KC_NO,  KC_NO,  KC_NO,                     KC_NO, KC_NO,  KC_NO,  KC_NO,  RGB_SPD,  RGB_SPI,  KC_NO,  KC_NO, \
